      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <div className="contact__info">
            ...
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">+91 8492950740</h4>
              </div>
            </div>
          </div>
          ...
          <div className="contact__socials">
            <a
              href="https://www.facebook.com/profile.php?id=100014772544072"
            ...
            <a
              href="https://github.com/rohitbhagat9302"
              className="contact__social-link"
              target="_blank"
            >
              {" "}
            ...
            <a
              href="https://www.linkedin.com/in/rohit-bhagat-910371187/"
              className="contact__social-link"
              target="_blank"
            >
              {" "}
